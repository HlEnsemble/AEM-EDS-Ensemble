...
## Environments
- Preview: https://main--AEM-EDS-Ensemble--HlEnsemble.aem.page/
- Live: https://main--AEM-EDS-Ensemble--HlEnsemble.aem.live/
- Block Library: https://main--AEM-EDS-Ensemble--HlEnsemble.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `AEM-EDS-Ensemble` directory in your favorite IDE and start coding :)
